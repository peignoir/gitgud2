...
const buildDefaultPrompts = (summary: string): Record<PromptKey, string> => ({
  ...
  profile: [
    ...
    "2. If the user shares their idea/fund details, acknowledge it briefly but say 'Got it, we'll cover the thesis in the Ideation Lab. First, let's lock your bio.'",
    "3. Use a checklist format to show progress: [ ] Bio/Background [ ] Current Objective.",
    "4. Once you have {founder, background} and a high-level 'current focus' (e.g. 'building a fund'), output 'READY' on a new line, say “Identity Scan Complete.”, and present the final bio summary.",
